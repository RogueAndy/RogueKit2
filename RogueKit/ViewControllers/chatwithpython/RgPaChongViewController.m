//
//  RgPaChongViewController.m
//  RogueKitDemo
//
//  Created by rogue on 2016/10/26.
...
@interface RgPaChongCell : UITableViewCell
...
@interface RgPaChongViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation RgPaChongViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RgPaChongCell *cell = [tableView dequeueReusableCellWithIdentifier:identity];
    if(!cell) {
    
        cell = [[RgPaChongCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identity];
